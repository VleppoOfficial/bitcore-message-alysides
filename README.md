...
bitcore-message-alysides adds support for verifying and signing alysides messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-alysides
```

```sh
bower install bitcore-message-alysides
```

To sign a message:

```javascript
var bitcore = require('bitcore-lib-alysides');
var Message = require('bitcore-message-alysides');
